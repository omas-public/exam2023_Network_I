...
sudo ip netns exec host2 ip address add 192.169.0.254/26 dev host2-e0

sudo ip netns exec host2 ping -c 3 192.168.0.1 -I 192.168.0.254
...
以下記述欄
50点くらいだと思います。
この講義でインターネット通信の方法、データの渡され方を学びました。通信の方法は意外とシンプルだけど私にはまだ少し分かりづらいところがあって少し難しさを感じました。もっと勉強をしてまたい1から学んでみたいと思いました。
